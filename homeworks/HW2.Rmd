...
<br>
This homework again uses the **sparrows.csv** dataset we used in homework 1. To begin, set your working directory (`Session -> Set Working Directory`) to the appropriate folder on your computer where the dataset is located, and read the dataset into R:

```{r}
sparrows <- read.csv("/Users/sjspielman/Teaching/bio5312_fall2017/datasets/sparrows.csv")
```
