...
+ Convert the written question into a probability statement
+ In a R code chunk, employ R as a calculator to compute values and probabilities
+ Provide the final probability answer

Consider these example questions and answers as templates. For any probability statement with a corresponding probability equation (any probability with *and* or *or*, any conditional probability, or any Bayes Theorem question), be sure to provide the full probability equation (left and right of equals sign) as in example 2:
...
**Probability statement:* `P(setosa and sepal width <= 3) = P(setosa) x P(sepal width >= 3)`
...
*Probability statement: * `provide statement here (full Bayes theorem statement!)`.
```{r}
### Enter your calculations here
...
*Probability statement: * `provide statement here (including left and right of =)`.
```{r}
### Enter your calculations here
